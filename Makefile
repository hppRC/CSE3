...
parser: y.tab.c y.tab.h lex.yy.c symbol-table.c data-structures.c display-llvm.c
	 cc y.tab.c lex.yy.c symbol-table.c data-structures.c display-llvm.c -ll -o parser
