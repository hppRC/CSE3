; ModuleID = './samples/c/fortest.c'
source_filename = "./samples/c/fortest.c"
...
define dso_local i32 @main() #0 {
  ...
  %2 = call i32 (i8*, ...) @__isoc99_scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0), i32* @s)
